 ...
 * UserOnlyLoginBaseConverter.java
 * $Id$
 */
...
@Stateless(name = "UserOnlyLoginBaseConverter")
public class UserOnlyLoginBaseConverter extends AbstractConverter<UUID, UserLogin, UserOnlyLoginDto>
